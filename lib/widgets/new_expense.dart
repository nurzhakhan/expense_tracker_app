    ...
    if (_titleController.text.trim().isEmpty || amountIsInvalid || _selectedDate == null) {
      showDialog(
        ...
        builder: (context) => AlertDialog(
          ...
          content: const Text('Please ma1ke sure a valid title, amount, date and category was entered. '),
          actions: [
            TextButton(
              onPressed: () {
            ...
            children: [
              ...
              Expanded(
                child: Row(
                  ...
                  children: [
                    Text(
                      _selectedDate == null ? 'No date selected' : formatter.format(_selectedDate ?? DateTime.now()),
                    ),
            ...
            children: [
              DropdownButton(
                ...
                items: Category.values
                    .map((category) => DropdownMenuItem(value: category, child: Text(category.name.toUpperCase())))
                    .toList(),
                onChanged: (value) {
                  if (value == null) {
                    return;
              ...
              ElevatedButton(onPressed: () => _submitExpensesData(), child: const Text('Save Expense')),
            ],
          ),
        ],
      ),
